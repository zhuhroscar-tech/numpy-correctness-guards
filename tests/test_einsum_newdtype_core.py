"""Tests for numpy_correctness_guards.guards.einsum_newdtype.core.
...
from numpy_correctness_guards.guards.einsum_newdtype.core import (
    BugDetectionResult,
    is_new_style_dtype,
    naive_einsum,
    safe_einsum,
...
def test_live_reproduction_of_numpy_32671():
    ...
    from numpy_correctness_guards.guards.einsum_newdtype.core import detect_einsum_newstyle_dtype_bug
...
def test_regression_this_exact_case_was_wrong_or_crashes_before_the_fix():
    ...
    proc = subprocess.run(
        [
            sys.executable,
            "-m",
            "numpy_correctness_guards.guards.einsum_newdtype._worker",
            "matmul_contraction",
        ],
        capture_output=True,
        text=True,
